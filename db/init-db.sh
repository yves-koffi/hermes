...
CREATE USER ${ACCOUNT_USER}
  WITH ENCRYPTED PASSWORD '${ACCOUNT_PASSWORD}'
  NOSUPERUSER NOCREATEDB NOCREATEROLE;
...
GRANT USAGE, CREATE ON SCHEMA public TO ${ACCOUNT_USER};
...
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO ${ACCOUNT_USER};

ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT ALL ON TABLES TO ${ACCOUNT_USER};

ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT ALL ON SEQUENCES TO ${ACCOUNT_USER};

ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT ALL ON FUNCTIONS TO ${ACCOUNT_USER};

-- ==========================================
-- STORE PURCHASE DATABASE
-- ==========================================

\connect postgres

CREATE DATABASE ${STORE_PURCHASE_DB};

CREATE USER ${STORE_PURCHASE_USER}
  WITH ENCRYPTED PASSWORD '${STORE_PURCHASE_PASSWORD}'
  NOSUPERUSER NOCREATEDB NOCREATEROLE;

GRANT CONNECT ON DATABASE ${STORE_PURCHASE_DB} TO ${STORE_PURCHASE_USER};

\connect ${STORE_PURCHASE_DB}

GRANT USAGE, CREATE ON SCHEMA public TO ${STORE_PURCHASE_USER};

GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ${STORE_PURCHASE_USER};
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO ${STORE_PURCHASE_USER};
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO ${STORE_PURCHASE_USER};

ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT ALL ON TABLES TO ${STORE_PURCHASE_USER};

ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT ALL ON SEQUENCES TO ${STORE_PURCHASE_USER};
